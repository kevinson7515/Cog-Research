...
#SBATCH --job-name=cog-research-drbench
#SBATCH --output=/home/export/base/ycsc_chenkh/hitici_07/online1/Cog-Research/logs/deepresearch_bench_%j.out
#SBATCH --error=/home/export/base/ycsc_chenkh/hitici_07/online1/Cog-Research/logs/deepresearch_bench_%j.out
...
REQUESTED_VLLM_PORT="${VLLM_PORT:-8012}"
...
export DEEPRESEARCH_TASKS_PATH="${DEEPRESEARCH_TASKS_PATH:-${PROJECT_ROOT}/data/tasks_and_rubrics.jsonl}"
export DEEPRESEARCH_START_INDEX="${DEEPRESEARCH_START_INDEX:-1}"
export DEEPRESEARCH_MAX_TASKS="${DEEPRESEARCH_MAX_TASKS:-0}"
export DEEPRESEARCH_WORKSPACE_ROOT="${DEEPRESEARCH_WORKSPACE_ROOT:-${PROJECT_ROOT}/work_space/deepresearch_bench_${RUN_TIMESTAMP}}"
export DEEPRESEARCH_RESULTS_PATH="${DEEPRESEARCH_RESULTS_PATH:-${PROJECT_ROOT}/deepresearch_bench_results_${RUN_TIMESTAMP}.jsonl}"
export DEEPRESEARCH_INCLUDE_RUBRIC_IN_PROMPT="${DEEPRESEARCH_INCLUDE_RUBRIC_IN_PROMPT:-0}"

# Keep QUIZ_FILE_PATH as a compatibility alias for code that logs this variable.
export QUIZ_FILE_PATH="${DEEPRESEARCH_TASKS_PATH}"
...
# 8. Run cog-research
# -----------------------------------------------------------------------------
echo "Starting cog-research DeepResearch-Bench II text-only runner..."
echo "  DEEPRESEARCH_TASKS_PATH=${DEEPRESEARCH_TASKS_PATH}"
echo "  DEEPRESEARCH_START_INDEX=${DEEPRESEARCH_START_INDEX}"
echo "  DEEPRESEARCH_MAX_TASKS=${DEEPRESEARCH_MAX_TASKS}"
echo "  DEEPRESEARCH_WORKSPACE_ROOT=${DEEPRESEARCH_WORKSPACE_ROOT}"
echo "  DEEPRESEARCH_RESULTS_PATH=${DEEPRESEARCH_RESULTS_PATH}"
